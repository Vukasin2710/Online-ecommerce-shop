...
function CardComponent({product, isGrid}) {
  return (
    <div className={isGrid === 'gridView' ? "w-[300px] border border-border-LightGray rounded-[20px] flex flex-col items-center justify-center" : "w-full flex items-center border border-gray-200 justify-between px-[10px] rounded-lg"}>
      <div>
